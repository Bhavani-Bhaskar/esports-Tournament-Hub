    ...
    <div className="flex justify-center items-center min-h-screen bg-[#00111c]">
        ...
        <form>
            ...
            type="text"
                ...
                aria-label="Username"
                className="w-full h-full bg-transparent border-none outline-none border-2 border-opacity-20 rounded-full text-white p-5 pr-14 placeholder-white bg-[#00253e]"
            />
            ...
            <button
            type="submit"
            className="w-full h-12 bg-[#00406c] text-white rounded-full shadow-md text-lg font-semibold cursor-pointer hover:bg-[#003356] transition-all duration-300"
            >
            Sign Up
            </button>
